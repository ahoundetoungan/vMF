...
```
### How to use vMF
I provide a vignette [[pdf version](https://nbviewer.jupyter.org/github/ahoundetoungan/vMF/blob/master/doc/vMFdocx.pdf), [html version](https://ahoundetoungan.com/blog/2017/12/01/An-R-Package-for-Fast-Sampling-from-von-Mises-Fisher-Distribution)] that fully documents the package. Moreover, each function of the package has a help page accessible using `?name-of-the-function`. 